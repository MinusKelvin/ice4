...
sections = []
sizes = [64, 32, 32, 32, 32, 64, 64, 1, 8, 1, 1, 1, 1, 1, 8] * 2
acc = 0
for s in sizes:
...
print(f"king opp pawn tropism mg: {[round(v) for v in sections[14]]}")
print(f"king opp pawn tropism eg: {[round(v) for v in sections[eg+14]]}")
