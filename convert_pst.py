...
sections = []
sizes = [64, 16, 3, 16, 3, 16, 3, 16, 3, 16, 64, 1, 8, 1, 1, 1, 1, 1, 1, 5] * 2
acc = 0
for s in sizes:
...
print(f"close piece mg: {[round(v) for v in sections[19]]}")
print(f"close piece eg: {[round(v) for v in sections[eg+19]]}")
