...
sections = []
sizes = [48, 16, 3, 16, 3, 16, 3, 16, 3, 16, 48, 1, 8, 1, 1, 1, 1, 1, 1, 4, 1, 1, 8] * 2
acc = 0
for s in sizes:
...
print(f"knight mobility mg: {[round(v) for v in sections[22]]}")
print(f"knight mobility eg: {[round(v) for v in sections[eg+22]]}")
