...
PARAM(LMR_FACTOR, double, 0.71, 0.0, 2.0, 0.2, 0.002)
PARAM(LMR_CONSTANT, double, 0.06, -1.0, 2.0, 0.2, 0.002)
PARAM(LMR_PV, double, 0.26, -2.0, 2.0, 0.2, 0.002)
PARAM(LMR_IMPROVING, double, -0.49, -2.0, 2.0, 0.2, 0.002)
PARAM(LMR_TT_CAPTURE, double, 1.16, -2.0, 2.0, 0.2, 0.002)
PARAM(LMR_TT_PV, double, -0.25, -2.0, 2.0, 0.2, 0.002)
PARAM(LMR_HISTORY, double, 4557.0, 100.0, 5000.0, 500.0, 0.002)
