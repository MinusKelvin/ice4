...
PARAM(IIR_MIN_DEPTH, int, 3, 0.0, 10.0, 0.5, 0.002)
...
PARAM(CORRHIST_NONPAWN_DIV, int, 256, 10.0, 1024.0, 50.0, 0.002)
...
PARAM(RFP_MAX_DEPTH, int, 8, 1.0, 10.0, 0.5, 0.002)
PARAM(NMP_MIN_DEPTH, int, 2, 0.0, 10.0, 0.5, 0.002)
...
PARAM(RAZOR_MAX_DEPTH, int, 6, 0.0, 10.0, 0.5, 0.002)
PARAM(RAZOR_MARGIN, int, 65, 1.0, 100.0, 15.0, 0.002)
PARAM(RAZOR_CONSTANT, int, 195, 0.0, 500.0, 50.0, 0.002)
PARAM(IID_MIN_DEPTH, int, 3, 0.0, 10.0, 0.5, 0.002)
PARAM(IID_REDUCTION, int, 7, 1.0, 10.0, 0.5, 0.002)
...
PARAM(LMP_FACTOR, double, 0.5, 0.1, 1.0, 0.2, 0.002)
PARAM(LMR_FACTOR, double, 0.65, 0.0, 2.0, 0.2, 0.002)
PARAM(LMR_CONSTANT, double, 0.33, -1.0, 2.0, 0.3, 0.002)
PARAM(LMR_HISTORY, int, 3842, 100.0, 10000.0, 500.0, 0.002)
PARAM(LMR_CAPTHIST, int, 3842, 100.0, 10000.0, 500.0, 0.002)
PARAM(HIST_QUAD_UPDATE, double, 5.6, 0.0, 10.0, 1.0, 0.002)
PARAM(HIST_EVAL_MARGIN, int, 42, 0.0, 100.0, 10.0, 0.002)
PARAM(CORRHIST_UPDATE_CONSTANT, int, 2, 0.0, 50.0, 3.0, 0.002)
...
PARAM(ASP_INITIAL, int, 9, 3.0, 22.0, 1.0, 0.002)
PARAM(ASP_WIDEN, double, 1.8, 1.5, 2.5, 0.2, 0.002)
