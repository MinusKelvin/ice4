// loss: 0.07862    train id: 2024-10-28-17-11-06-frzn-big3
...
#define DATA_STRING L"6PN761, :G>750%!:BKGE:-&>JRTM?:-?Mj\\XWD6/-CJ;2=7lx¤  -3:<=4,MX[WS\\M  ))$'%/&,!# *:9; \"*/50/*5;6.)2'  !\"$$%)&fa? !M]jFF6 1+MO +/8539>T \" &24gOVLIMS`YO OPTWVJ@NP\\±  &-1%*(+#$++*''')-'%!&++88/'%,17S^L:3:GFV`bGDA<: 5JT\\I<9\"5GKJC7  \"./2./;%(',),'   %/209:,--)\"&# ! ?Vdena ,6==>9;#-=GQWL %6@G@@3 8#  suofC  .JiÖ,UJ<5555, +>IQW\\ $2NƊ"
...
#define STORM_PAWN_RANK_INDEX 131
#define STORM_PAWN_RANK S(-27, -84)
...
#define KING_PASSER_DIST_INDEX 144
