// loss: 0.07863    train id: 2025-02-25-16-14-44-frzn-big3
...
#define DATA_STRING L"7QN962, :G<861%\"<CMIG;-'BMVXPB</OXxgc_K=% CVL<>5ht\177§  -4:=>6-MX[XT]N  ))$'%.', \" +;=; #+0622,<B=5/2,  !\"#$%)'QI0! CSZDI9 1,PM +-4# %14i[[UW[`mg[ \\[adeY=KMZ´  &-2&)(*#%,,+&&%'+$# %+)32(\"!).4BL5'!+:;SVQ0/238 5JTXF:7#5HKHB6  \".-0-.9%)(-*-(   %.0-58-..)\"&\" ! @VabiW +5;:720*0<CNTK %8AIBB5 ;\" \" 0MmÎ;e[LEGFE; 8P[djn #0Jơ"
