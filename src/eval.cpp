// loss: 0.07903    train id: 2024-01-04-11-14-07-frzn-big3

#define S(a, b) (a + (b * 0x10000))

int QUADRANTS[] = {
    S(217, 234), S(229, 239), S(224, 233), S(223, 241),
    S(237, 301), S(234, 307), S(239, 303), S(234, 306),
    S(293, 557), S(305, 575), S(300, 550), S(322, 564),
...
#define DATA_LOW "7MO632* ALG?=;+(?DSOMB0*EM\\\\TG;2T[|eb`E=@#b)%e@l2C95+,2631%'#$+7-5' ()=C,4759BLF\"!7CEIWREWOAE]z@S<;YB #2G61*\\uai )02+2@>6FHO=;NM\"$ $'30))75-')*7/28? +32)4/1$%*, (,/-.33120,,)$$ )7A75//#&5880-+(/./0240352/39:;AS@NQGNC} :??FLC0-$ %(4,3?4-'.:2RVKA79BGpraNGIVb@6)[Tl{/@AuAACL^\"2/ 2JG3EXWH5<B/ Lfk\\luye{'-p&27 -*)$)*+0034*352\"#' ''&%\"#%$'*)&% \",)$(/-<EA6FNT"
#define DATA_HIGH "                                           !!                                                                                                                                                                            !!!!!!!                                !!!    !!!                                !! !!!                                                "
...
#define KING_RING_ATTACKS S(7, -2)
