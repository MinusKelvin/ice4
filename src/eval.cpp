// loss: 0.0791    train id: 2024-09-01-21-31-09-frzn-big3
...
#define DATA_STRING L"6OM410+ @MD<:9,(>FPMK@1*DOYXPD=2T_xa^]G<<&\\\177`Ch////////////////,4' ('<A+4658AKD  5BDHTPGUNCG]wAW@?]D #4G50*\\t^i )02*2@>6FHO=;NM\"$ $'30))85-')*7/28? +32)5/1#&*, ),/..33131,,*$$ )4>42.0%)487//.*/,./15244//27:=@P:LOCLCzx¤¤                 GKB7-07;egYE>@KVSLern66:GV\"2/ 3JG4EXWI6=C0 Lfk]luzf|q -*)$(*+1144*353!#& '''&\"#&%'*)'% \",*#(/.>FA8GOT"

#define PAWN_OFFSET S(25, 72)
#define PASSED_PAWN_OFFSET S(-15, 0)
