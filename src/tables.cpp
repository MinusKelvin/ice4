...
#define KNIGHT_OUTPOST_MG 3
#define KNIGHT_OUTPOST_EG 16

const char *DATA_STRING = "ASV=:>71DQIB@A76EKUROH;8KR`\\YQGAU\\rmi_PGA e~zl9g&*3;86/1! ./.)(&&+)&&).*/10-/355;J>EEBD?aRt~qvzw/:42/++1-.%&  ,0.-#!$&57.60036E>4+74=FMSQQ>>LW~R$$  ##+\"'-'%$&*'6940,,13FF?6039?YUO;6<GPl~_@>?JNO>@_6 \"4KPH7xu[C&2. 5LI2VbcTVhg[ '),.26245423-209.% ,/,4,CNK2MWc139? )21*512('01 &&\"()&($%(''.,*#  !-73..<8611:D 0&.+3872=EH,AGJ #).)-94+?=E;8HF BUYN]bjWisy`pz~";
...
void init_tables() {
    unpack_full(0, PAWN, 1.23, 9); // average: 66
    unpack_full(1, PAWN, 1.118, 93); // average: 124
    unpack_full(0, PASSED_PAWN, 1.199, -14); // average: 13
    unpack_full(1, PASSED_PAWN, 1.962, -5); // average: 43
    unpack_smol(0, KING, 1.0, -39); // average: 1
    unpack_smol(1, KING, 1.0, -38); // average: 3
    unpack_half(0, QUEEN, 1.0, 637, 637, 640, 653); // average: 652
    unpack_half(1, QUEEN, 1.0, 1272, 1328, 1266, 1332); // average: 1298
    ...
    unpack_half(0, KNIGHT, 1.0, 222, 239, 225, 244); // average: 243
    unpack_half(1, KNIGHT, 1.217, 265, 271, 265, 271); // average: 343
