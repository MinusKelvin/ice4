...
int STARTPOS_LAYOUT[] = { ROOK, KNIGHT, BISHOP, QUEEN, KING, BISHOP, KNIGHT, ROOK };

int get_data(int i) {
    auto data_low = DATA_LOW;
    auto data_high = DATA_HIGH;
    return data_low[i] - 32 + 95 * (data_high[i] - 32) +
        0x10000 * (data_low[i+176] - 32 + 95 * (data_high[i+176] - 32));
}
