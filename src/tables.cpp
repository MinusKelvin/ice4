...
int get_data(int i) {
    auto DATA_LOW = "-76+)($ 253/-,$#12965/%$46=<81,(<?NC@>1.0!?RN@.E*2.,'(*-+*$$##&-(,%!%%/2',-,.274\" -/25<92<704>M/B66E5  +7.*'CODH $()%)0/*349..87!\" \"$)($%,*'$$&-(),/ &*)%+))\"#&% $&'''))*)(&%$##!%,0++() !(**&$%#%%%%'('))(%'+,-19/57373LLZ\\\\ac_(&\" #$*&)/*'$'-)9:50+,14GG?634:@]XQ>9DKT``K1016@!)' *75*3==6+/2( 6CE>FJMBLRVHSX[ &%%\"%%&((*+%*+)!\"$ $###!!\"\"$%$$# !%$\"$'&.2/+369";
    return (DATA_LOW[i] + 0x10000 * DATA_LOW[i+176] - S(32, 32)) * 2;
}
