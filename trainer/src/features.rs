    ...
    pub fn extract(&mut self, board: &Board) {
        for &piece in &Piece::ALL {
            for unflipped_square in board.pieces(piece) {
                ...
                let king_ring_defends = (get_king_moves(board.king(color)) & mob).len();
                ...
                if piece != Piece::King {
                    ...
                    self.king_defend_weight[piece as usize] += inc * king_ring_defends as f32;
                }
            }
        }
